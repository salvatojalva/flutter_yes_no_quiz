...
class CorrectWrongOverllay extends StatefulWidget{
  final bool _isCorrect;
  final VoidCallback _onTap;

  CorrectWrongOverllay(this._isCorrect, this._onTap);

  @override
  State createState() => new  CorrectWrongOverllayState();

}

class CorrectWrongOverllayState extends State<CorrectWrongOverllay> with SingleTickerProviderStateMixin {
